...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/3.0.7/reference/htmlsingle/#howto.data-access.exposing-spring-data-repositories-as-rest)
* [Spring Data JPA](https://docs.spring.io/spring-boot/docs/3.0.7/reference/htmlsingle/#data.sql.jpa-and-spring-data)
* [Liquibase Migration](https://docs.spring.io/spring-boot/docs/3.0.7/reference/htmlsingle/#howto.data-initialization.migration-tool.liquibase)
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.0.7/reference/htmlsingle/#howto.data-initialization.migration-tool.flyway)
